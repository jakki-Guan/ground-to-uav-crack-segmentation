...
Stage:
- `hrda`: `HRDA (MiT-B5)` | threshold `0.3` | checkpoint `/home/jakeguan/dev/crack-detection/work_dirs/hrda_crack500_to_uav_mitb5_s0_360/iter_40000.pth` | config `/home/jakeguan/dev/crack-detection/configs/hrda/crack500_to_uav_hrda_mitb5_s0.py`
